...
description: Use when building or debugging React web clients for Frick apps with @fricken/react, @fricken/core, design-web, or the browser demo patterns.
---
...
Guidance:
- Use `@fricken/react` hooks and provider patterns over raw sync plumbing.
...
- Use design tokens from `@fricken/design-web` when available.
